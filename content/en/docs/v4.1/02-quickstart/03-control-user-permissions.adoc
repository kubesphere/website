...
keywords: "Kubernetes, {ks_product-en}, Quick Start, User Permissions"
...
As a multi-tenant system, {ks_product-en} supports controlling user permissions based on roles at the platform, cluster, workspace, and project levels, achieving logical resource isolation.
