...
10. 点击持续部署右侧的 <img src="/images/docs/v3.3/common-icons/three-dots.png" width="15" />，您可以执行以下操作：
    - 编辑信息：编辑别名和描述信息。
...
2. 在右侧的**服务**区域，找到已部署的应用，并点击右侧 <img src="/images/docs/v3.3/common-icons/three-dots.png" width="15" />，选择**编辑外部访问**。
