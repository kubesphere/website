...
4. 新创建的角色将列在 **DevOps 项目角色**中。您可以点击右侧的 <img src="/images/docs/common-icons/three-dots.png" height="15px"> 对其进行编辑。
...
2. 点击 <img src="/images/docs/common-icons/invite-member-button.png" height="15px"> 邀请帐户加入此 DevOps 项目，并向此帐户授予 `pipeline-creator` 角色。
