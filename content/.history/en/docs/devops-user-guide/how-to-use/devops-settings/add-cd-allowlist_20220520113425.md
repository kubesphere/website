...
4. In **Continuous Deployment Allowlist** on the right, clcik **Enable Allowlist**.

5. In the **Edit Allowlist** dialog box, choose a code repository and the cluster and project where the code deployment will be deployed. deployment location选择代码仓库和部署位置，点击**OK**。您可以继续点击**Add**以添加多个代码仓库和部署位置。