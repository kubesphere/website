...
1. Log in to the KubeSphere console as `project-regular`. In the navigation tree on the left, click **DevOps Projects**.
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Synchronization status of the continuous deployment, which includes the following:<br/>
           <ul>
           <li>Synced: Resoruces have been synchronized.</li>
           <li>Out of sync: The actual running state of resources is not as desired.</li>
           <li>Unknown: The resource synchronization state is unknown.</li></td>
      </tr>
      <tr>
