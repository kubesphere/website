...
9. In **Sync Settings**, select the following options as needed:
    ...
    - **Prune last**: 直到所有的资源都已经同步且处于健康状态才删除不存在的资源。Deletes resources that no longer exist after the other resources have been deployed and become healthy, and after all other waves completed successfully.
