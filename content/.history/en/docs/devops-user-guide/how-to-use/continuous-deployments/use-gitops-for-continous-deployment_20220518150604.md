...
- You need to create a workspace and a user (`project-admin`). This user must be invited to the workspace with the `workspace-self-provisioner` role. See [Create Workspaces, Projects, Users and Roles](../../../../quick-start/create-workspace-and-project/).

- You need to [enable KubeSphere DevOps](../../../../pluggable-components/devops/).
...
1. Log in to the  `project-admin` 用户登录 KubeSphere 控制台， 选择 **平台管理 > 访问控制**。
