    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Health status of the continuous deployment, which includes the following:<br/>
           ...
           <li>Progressing：The resoures are still working despite that they are unhealthy and may soon be resumed to the healthy state. This is the default state.</li>
           <li>Suspended：资源已经被暂停并等待恢复。The resouces have been suspended and are waiting to be resumed.</li>
